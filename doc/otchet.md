...
Исходный код программы: https://github.com/ledxdd/cse-labwork2

Результат работы программы:![Screenshot 2026-02-22 at 22.39.55.png](../../../../../var/folders/c4/1gp6hm7d41x93vzg1b_6sv9h0000gn/T/TemporaryItems/NSIRD_screencaptureui_5KcNQK/Screenshot%202026-02-22%20at%2022.39.55.png)

Выводы:

Был получен опыт в использовании наследования классов, перегруженных функций. Изучены основы ООП. 
Изучены модификаторы классов final и static. А также пакеты и использование import
